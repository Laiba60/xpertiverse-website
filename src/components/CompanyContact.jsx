          ...
          {Object.values(companyContactData).map((item, index) => (
            ...
            >
              <div className="flex flex-col">
                <h2 className="bg-linear-to-r from-[#9016B5] to-[#245EBD] text-transparent bg-clip-text text-[25px] font-semibold">
                  {item.heading}
                </h2>
              ...
              <div className="text-white text-[30px] bg-linear-to-r from-[#9016B5] to-[#245EBD] px-5 py-4 rounded-lg flex items-center justify-center">
                {icons[item.icon]}
              </div>
            </div>
          ))}
